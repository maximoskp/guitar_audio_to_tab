...
audio_encoder = keras.layers.Conv1D(32, kernel_size=8, strides=2, activation='relu')(input_audio)
audio_encoder = keras.layers.MaxPooling1D(2)(audio_encoder)
audio_encoder = keras.layers.Dropout(0.3)(audio_encoder)
audio_encoder = keras.layers.BatchNormalization()(audio_encoder)
audio_encoder = keras.layers.Conv1D(64, kernel_size=4, strides=2, activation='relu')(audio_encoder)
audio_encoder = keras.layers.Dropout(0.3)(audio_encoder)
audio_encoder = keras.layers.BatchNormalization()(audio_encoder)
audio_encoder = keras.layers.MaxPooling1D(2)(audio_encoder)
audio_encoder = keras.layers.Conv1D(128, kernel_size=3, strides=2, activation='relu')(audio_encoder)
audio_encoder = keras.layers.Dropout(0.3)(audio_encoder)
audio_encoder = keras.layers.BatchNormalization()(audio_encoder)
audio_encoder = keras.layers.MaxPooling1D(2)(audio_encoder)
audio_encoder = keras.layers.Conv1D(512, kernel_size=3, activation='relu')(audio_encoder)
audio_encoder = keras.layers.Flatten()(audio_encoder)
audio_encoder = keras.models.Model( inputs=input_audio, outputs=audio_encoder )
